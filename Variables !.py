#so before i get sleep let me explain to you how variables works: X is a variable that we can store in it a string, number, integer or a mathematic formulat...
